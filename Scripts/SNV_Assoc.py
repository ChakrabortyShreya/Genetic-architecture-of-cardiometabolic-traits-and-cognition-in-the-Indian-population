...
if rank < len(z):
	...
	with open(z[rank]+"/"+z[rank]+".log","w") as f:
		...
		os.system("time rvtest --inVcf SANSCOG-imputed-filtered-0.6-sorted-mac2-annot-atgc-rem-maf0.0002.vcf.gz  --out "+z[rank]+"/2_108_"+z[rank]+"_LitCat 
		...
		os.system("time Rscript ../1.Clump_Pre_process.R  "+z[rank]+"/"+z[rank]+"_LitCat.FamGrammarGamma.assoc")
		f.write("Done.\n")
		f.write("Performing LD clump...\n")
		os.system("time plink --bfile SANSCOG-imputed-filtered-0.6-sorted-mac2-annot-atgc-rem-maf0.0002_plink1.9 --clump "+z[rank]+"/"+z[rank]+"_LitCat.FamGrammarGamma.assoc_Processed 
              --clump-best --clump-field Pvalue --clump-kb 250 --clump-p1 5e-6 --clump-p2 5e-5 --clump-r2 0.7 --clump-snp-field ID --clump-verbose 
              --out "+z[rank]+"/"+z[rank]+"_LitCat.FamGrammarGamma.assoc_Processed_Indep_Hits_own  --threads 30")
		f.write("Done.\n")
		f.write("Processing .clumped file....\n")
		os.system("time python ../2.Clump_post_process.py "+z[rank]+"/"+z[rank]+"_LitCat.FamGrammarGamma.assoc_Processed_Indep_Hits_own.clumped > "+z[rank]+""+z[rank]+"_LitCat.FamGrammarGamma.assoc_Processed_Indep_Hits_own.clumped_Formatted.txt")
		f.write("Done.\n")
		f.write("Getting Independent hits and clumps....\n")
		os.system("time python ../3.Get_Indep.py "+z[rank]+"/"+z[rank]+"_LitCat.FamGrammarGamma.assoc_Processed_Indep_Hits_own.clumped_Formatted.txt "+z[rank]+"/"+z[rank]+"_LitCat.FamGrammarGamma.assoc_Processed "+ z[rank]+"/2_108_NoAPOE_"+z[rank]+"_LitCat_corrected.FamGrammarGamma.assoc_Processed_Indep_Hits_own.clumped_Formatted_Final.txt")
		f.write("Done.\n")
		f.write("GWAS summary statistics is ready!\n")

		f.write("Fetching SNPEFF annotations on Independent clumps....\n")
		os.system("time python ../4.SNP_EFF_Annot.py "+ z[rank]+"/"+z[rank]+"_LitCat.FamGrammarGamma.assoc_Processed_Indep_Hits_own.clumped_Formatted_Final.txt")
		f.write("Done.\n")
		f.write("Writing Tables and Plotting QQ plots...\n")
		os.system("time Rscript ../5.Get_hits.R "+ z[rank]+"/"+z[rank]+"_LitCat.FamGrammarGamma.assoc_Processed "+z[rank]+"/ "+z[rank])
		f.write("Done.")
		f.close()
